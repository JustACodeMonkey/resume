...
export const SimpleCard = ({ children, className, title }: SimmpleCardProps) => {
  return (
    <section className={"border-y-2 border-black/25 dark:border-white/40 bg-white/80 dark:bg-black/80 p-2 rounded-lg min-w-60 space-y-4 drop-shadow-md " + className}>
      {title && (
